      ...
      <div className='md:col-span-4 col-span-5 h-full cursor-pointer'>
        <Slider {...settings}>
          <div className='relative'>
            ...
            <div className='absolute top-0 right-0 mx-5 mt-3 md:my-5 flex flex-col items-start w-1/2'>
              <span className='bg-yellow-300 px-1 rounded-md'>Free Shipping - Orders Over 100$</span>
              <h1 className='text-xl lg:text-4xl xl:text-5xl text-white font-semibold my-1'>Free Shipping on Orders Over <span className='text-purple-500'>100$</span></h1>
              ...
              <div className='flex justify-center items-center bg-purple-400 px-2 py-1 mt-3 md:mt-5 rounded-lg text-white hover:bg-purple-500'>
                <Link to="/products"><span className='text-md md:text-lg '>Shop Now</span> <i className='fas fa-arrow-right mx-1'></i></Link>
              </div>
            </div>
          </div>
          <div className='relative'>
            ...
            <div className='absolute top-0 right-0 mx-5 mt-3 md:my-5 flex flex-col items-start w-1/2'>
              ...
              <h1 className='text-xl lg:text-4xl xl:text-5xl text-white font-semibold my-2'>Get Benfits of our Big Sale this Month.</h1>
          ...
          <div className='relative'>
            ...
            <div className='absolute top-0 left-0 mx-5 mt-3 md:my-5 flex flex-col items-start w-1/2'>
              <span className='bg-purple-300 px-1 rounded-md'>10% Cash Back on Self-Care Products.</span>
              <h1 className='text-xl lg:text-4xl xl:text-5xl text-white font-semibold my-2'><span className='text-purple-500'>10%</span> Cash Back on Self-Care Products.</h1>
          ...
          <div className='relative'>
            ...
            <div className='absolute top-0 right-0 mx-5 mt-3 md:my-5 flex flex-col items-start w-1/3'>
              <span className='bg-rose-400 px-1 rounded-md'>Sale Discount 50%</span>

              {/* <div className='grid grid-cols-4 my-2'>
                <div className='rounded-full w-[50px] h-[50px] md:w-[80px] md:h-[80px] me-1 my-2 col-span-2 lg:col-span-1'>
              ...
              <div className='flex justify-start items-center flex-wrap mt-2'>
                <div className='rounded-full w-[50px] h-[50px] md:w-[80px] md:h-[80px] me-1 my-2'>
                  <img src={sliderImg6} className='w-full h-full rounded-full object-fit' alt="slider products" />
                </div>
                <div className='rounded-full w-[50px] h-[50px] md:w-[80px] md:h-[80px] me-1 my-2'>
                  <img src={sliderImg5} className='w-full h-full rounded-full object-fit' alt="slider products" />
