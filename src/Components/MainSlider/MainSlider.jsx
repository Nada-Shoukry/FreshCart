    ...
    <div className="grid grid-cols-5 mb-10 gap-y-2">
        ...
        <Slider {...settings}>
          <div className='relative'>
            ...
            <div className='absolute top-0 right-0 mx-5 my-1 md:my-5 flex flex-col items-start w-1/2'>
              ...
              <h1 className='text-2xl lg:text-4xl xl:text-5xl text-white font-semibold my-2'>Free Shipping on Orders Over <span className='text-purple-500'>100$</span></h1>
              <p className='text-slate-900 italic mt-2'>Free Shipping to First-Time Customers only, after Promotions and Discounts are applied.</p>
          ...
          <div className='relative'>
            ...
            <div className='absolute top-0 right-0 mx-5 my-1 md:my-5 flex flex-col items-start w-1/3'>
      ...
      <div className='md:col-span-1 col-span-5'>
        <div className="flex md:flex-col md:w-100 flex-row">
          <img src={sliderImg7} className='w-1/2 md:w-full h-[100px]' alt="cart Images" />
          <img src={sliderImg8} className='w-1/2 md:w-full h-[100px]' alt="cart Images" />
          <img src={sliderImg9} className='w-1/2 md:w-full h-[100px]' alt="cart Images" />
        </div>
      </div>
    </div>
