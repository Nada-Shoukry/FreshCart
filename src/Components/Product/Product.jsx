    ...
    <>
        <div className="max-w-2xl mx-auto col-span-4 md:col-span-2 lg:col-span-1">
           <div className="relative bg-transparent shadow-md shadow-purple-400 hover:shadow-purple-600 rounded-lg max-w-sm dark:bg-gray-800 dark:border-gray-700">
              <div className='absolute top-0 left-0 border-[1px] px-1 border-purple-500 m-1 rounded-md bg-white text-purple-700 hover:bg-purple-500 hover:text-white cursor-pointer'>{product.category.name}</div>
              ...
              <div className="px-5">
                ...
                <div className="flex items-center justify-between px-5 py-2">
                  ...
                  <button onClick={() => addProductToWishlist(product._id, userToken)} className=" bg-white text-purple-600 border-[2px] border-purple-400 hover:bg-purple-500 hover:text-white focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm p-2 text-center dark:bg-purple-400 dark:hover:bg-purple-500 dark:focus:ring-purple-700">
                    <div className='flex justify-center items-center'>
                      <div className='mx-1'><i className='fa-regular fa-heart'></i> Add to Wishlist</div>
                    </div>                     
                  </button>
